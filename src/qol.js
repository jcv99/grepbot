  ...
  const ORCH_MS = 20000;
  // Nineteen registered handlers can create roughly 17 due dispatches/min at
  // base cadence. Six slots/tick provide 18/min service capacity; when action
  // traffic reaches the request-budget soft threshold, the conservative old
  // three-slot cap is restored until pressure falls.
